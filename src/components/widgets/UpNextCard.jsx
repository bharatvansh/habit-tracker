      ...
      <div className="mt-auto">
        ...
        <div className="flex items-center justify-between">
          ...
          <button 
            ...
            disabled={!upNextTask}
            className="size-10 rounded-full border border-white/10 flex items-center justify-center text-white hover:bg-white hover:text-black transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
